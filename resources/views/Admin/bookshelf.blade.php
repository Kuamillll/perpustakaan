...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="container-fluid">
            <a href="{{ url('tambah-bookshelf') }}" class="btn btn-primary">
            ...
            <table class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">{{ $bookshelf->bookshelf }}</td>
                        <td class="text-center">
                            <a href="{{ url('bookshelf/'.$bookshelf->id.'/edit') }}" class="btn btn-success btn-sm">
                            ...
                            <a href="{{ url('data/'.$bookshelf->id.'/hapus')}}" class="btn btn-danger btn-sm">
